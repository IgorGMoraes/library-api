...
-   Endpoints principais:
    ...
    -   Buscar livros por título: `/book/title/{title}`. Caso o livro com o título buscado não esteja salvo no banco de dados a aplicação irá buscá-lo no Open Library Search API. 
